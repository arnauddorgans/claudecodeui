 ...
 * choice.
 *
 * Existing rows stay NULL, same as `model` and `effort` did when they were
 * added: clients fall back to the provider's default mode until the user
 * picks one or sends a turn with one chosen.
 */
